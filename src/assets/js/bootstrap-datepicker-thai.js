        ...
        $.extend(DatePicker.prototype, {
            fillThai: function () {
                ...
                this.picker
                        ...
                        .find('th.datepicker-switch')
                        .text((year + thai.adj) + '-' + (year + thai.adj + 9))
                        .end()
                        .find('td')
                        .find('span.year')
                        .each(
                ...
                year = parseInt(year / 100, 10) * 100;
                
                this.picker
                        .find('.datepicker-decades')
                        .find('th.datepicker-switch')
                        .text((year + thai.adj) + '-' + (year + thai.adj + 90))
                        .end()
                        .find('td')
                        .find('span.decade')
                        .each(
                ...
                year = parseInt(year / 1000, 10) * 1000;
                 
                this.picker
                        .find('.datepicker-centuries')
                        .find('th.datepicker-switch')
                        .text((year + thai.adj) + '-' + (year + thai.adj + 900))
                        .end()
                        .find('td')
                        .find('span.century')
                        .each(
